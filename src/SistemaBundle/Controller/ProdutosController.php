...
class ProdutosController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $produtos = $em->getRepository('SistemaBundle:Produtos')->findAll();

        return $this->render('SistemaBundle:Produtos:index.html.twig', array(
            'produtos' => $produtos,
        ));
    }
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('SistemaBundle\Form\ProdutosType', $produto);
        ...
        return $this->render('SistemaBundle:Produtos:new.html.twig', array(
            'produto' => $produto,
    ...
    public function showAction(Produtos $produto)
    {
        ...
        return $this->render('SistemaBundle:Produtos:show.html.twig', array(
            'produto' => $produto,
    ...
    {
        $deleteForm = $this->createDeleteForm($produto);
        $editForm = $this->createForm('SistemaBundle\Form\ProdutosType', $produto);
        ...
        return $this->render('SistemaBundle:Produtos:edit.html.twig', array(
            'produto' => $produto,
